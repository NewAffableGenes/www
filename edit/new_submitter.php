...
if (strlen($errorTitle) > 0) {
    ...
    $object = createDefaultSubmitter($mysqli, $treeId, nextLabel($mysqli, $treeId, $createType));
    $objectLink = createDefaultSubmitterLink($mysqli, $treeId, $type, $id, $object);
