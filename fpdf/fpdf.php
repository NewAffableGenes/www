...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function setAGFont($font) {
        $this->SetFillColor($font['background_R'], $font['background_G'], $font['background_B']);
        ...
        $font_family = strtolower($font['style']);
        $this->SetFont($font_family, $style, $font['size']);
        $this->SetTextColor($font['font_R'], $font['font_G'], $font['font_B']);
    }

    function addAGFont($font) {
        $style = "";
        if ($font['bold']) {
            $style .= 'B';
        }
        ...
        $font_family = strtolower($font['style']);
        $this->AddFont($font_family, $style);
    }
